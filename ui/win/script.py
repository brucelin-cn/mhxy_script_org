...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.line.setGeometry(QtCore.QRect(0, 40, 31, 351))
        ...
        self.missionrichang_shutdown_chk.setGeometry(QtCore.QRect(20, 380, 111, 16))
        ...
        self.shimeng_btn = QtWidgets.QPushButton(parent=self.richangTab1)
        self.shimeng_btn.setGeometry(QtCore.QRect(40, 240, 75, 23))
        self.shimeng_btn.setObjectName("shimeng_btn")
        self.shimeng_chk = QtWidgets.QCheckBox(parent=self.richangTab1)
        self.shimeng_chk.setGeometry(QtCore.QRect(20, 240, 21, 16))
        self.shimeng_chk.setText("")
        self.shimeng_chk.setChecked(True)
        self.shimeng_chk.setObjectName("shimeng_chk")
        self.jingyanlian_btn = QtWidgets.QPushButton(parent=self.richangTab1)
        self.jingyanlian_btn.setGeometry(QtCore.QRect(40, 280, 75, 23))
        self.jingyanlian_btn.setObjectName("jingyanlian_btn")
        self.jingyanlian_chk = QtWidgets.QCheckBox(parent=self.richangTab1)
        self.jingyanlian_chk.setGeometry(QtCore.QRect(20, 280, 21, 16))
        self.jingyanlian_chk.setText("")
        self.jingyanlian_chk.setChecked(True)
        self.jingyanlian_chk.setObjectName("jingyanlian_chk")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.shimeng_btn.setText(_translate("MainWindow", "师门"))
        self.jingyanlian_btn.setText(_translate("MainWindow", "经验链"))
